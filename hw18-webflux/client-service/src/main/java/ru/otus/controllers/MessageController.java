...
public class MessageController {
  ...
  private static final Long MAGIC_ROOM_ID = 1408L;
  ...
  public void getMessage(@DestinationVariable String roomId, Message message) {
    if (Long.valueOf(roomId).equals(MAGIC_ROOM_ID)) {
      return;
    }
    ...
    template.convertAndSend(
        String.format("%s%s", TOPIC_TEMPLATE, MAGIC_ROOM_ID), new Message(HtmlUtils.htmlEscape(message.messageStr())));
  }
